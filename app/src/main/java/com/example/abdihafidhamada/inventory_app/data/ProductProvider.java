package com.example.abdihafidhamada.inventory_app.data;
...
import com.example.abdihafidhamada.inventory_app.data.ProductContract.ProductEntry;

import java.net.URI;

/**
 * Created by Abdihafid Hamada on 8/14/2018.
 */
...
public class ProductProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        // Create and initialize a PetDbHelper object to gain access to the products database.
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that the quantity is not null and check that it's greater than or equal to 0
        Integer quantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
        if (quantity != null && quantity < 0) {
            throw new IllegalArgumentException("product requires valid quantity");
        }

        // Check that the price is not null and check that it's greater than or equal to 0
